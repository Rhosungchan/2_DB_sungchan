...
-- 1)  INSERT INTO 테이블명 VALUES(데이터, 데이터, ...)                         //////(반드시! 반드시! 반드시! 외울 것!)////////////
-- 테이블에 모든 컬럼에 대한 값을 INSERT할 때 사용
-- INSERT하고자 하는 컬럼이 모든 컬럼인 경우 컬럼명 생략 가능. 단, 컬럼의 순서를 지켜서 VALUES에 값을 기입해야 함

INSERT INTO EMPLOYEE2 VALUES('900','장채현','940107-2345678',
...
-- 선택안된 컬럼은 값이 NULL이 들어감(DEFAULT 존재 시 DEFAULT값으로 삽입됨)
...
-- 3. MERGE(병합) (참고만 하세요!(정처기, SQL 관련시험에서 작년에 나옴)
