...
-------------------------------------------------
-- Additional SELECT 8번)	 0
-- 춘 기술대학교의 2000년도 이후 입학자들은 학번이 A로 시작하게 되어있다. 
-- 2000년도 이전 학번을 받은 학생들의 학번과 이름을 보여주는 SQL 문장을 작성하시오.

SELECT STUDENT_NO , STUDENT_NAME 
FROM TB_STUDENT
--WHERE ENTRANCE_DATE < '2000-01-01'; -- 풀이 1번
WHERE STUDENT_NO NOT LIKE 'A%';       -- 풀이 2번
  	 
-------------------------------------------------
-- Additional SELECT 9번)	 0
...
-------------------------------------------------
-- Additional SELECT 13번) 0 
/* 학과 별 휴학생 수를 파악하고자 한다. 
 * 학과 번호와 휴학생 수를 표시하는  SQL문장을 작성하시오 */

-- 내 풀이 

SELECT DEPARTMENT_NO 학과 , COUNT(DECODE(ABSENCE_YN,'Y',1)) "휴학생 수" 
FROM TB_STUDENT 
GROUP BY DEPARTMENT_NO; 
